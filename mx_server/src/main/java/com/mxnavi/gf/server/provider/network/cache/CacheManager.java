...
import com.mxnavi.gf.misc.thread.ThreadPoolManager;
...
public final class CacheManager {
    ...
    public void init(Context context) {
        ...
        checkDiskCacheDir(diskCacheDir);
    ...
    /**
     * 检查路径目录是否存在，不存在则创建
     * @param diskCacheDir 缓存路径
     */
    private void checkDiskCacheDir(File diskCacheDir) {
    ...
    public void putCache(String key, String value) {
        ...
        checkDiskCacheDir(mDiskLruCache.getDirectory());
    ...
    private File getDiskCacheDir(Context context, String uniqueName) {
        ...
        Log.d(TAG, "Cache path : " + cachePath + File.separator + uniqueName);
